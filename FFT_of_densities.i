...
int potential()
{
      ...
      else
 {
  ...
  plan_k2r = fftw_plan_dft_c2r_3d( GV.NCELLS, GV.NCELLS, GV.NCELLS, in, out, (0U) );
  fftw_execute( plan_k2r );
  ...
  plan_r2k = fftw_plan_dft_r2c_3d( GV.NCELLS, GV.NCELLS, GV.NCELLS, out, in2, (1U << 6) );
  fftw_execute( plan_r2k );
